// ============================================================
// coworker-config.js v 1.26 COWORKER CONFIG - Configuration Only (No Execution Logic)
// ============================================================
...
const SYSTEM_FIELDS = [
  ...
  { 
    ...
    frappe_field: 1, 
    toplevel: 1,
    workflow_controlled: 1,
    requires_permission: ["submit", "cancel", "amend"],
    default_value: 0
  },
  { 
  ...
  { 
    ...
    toplevel: 1,
    acl_protected: 1,
    owner_or_higher_only: 1,
    validate_no_privilege_escalation: 1
  },
  { 
...
// Special field protection for User doctype
const USER_DOCTYPE_PROTECTED_FIELDS = [
  {
    fieldname: "user_type",
    system_user_only_on_update: 1,
    restricted_values_on_create: {
      "System User": ["System User", "Admin", "Desk User", "Website User"],
      "Admin": ["Desk User", "Website User"],
      "Desk User": [],
      "Website User": []
    }
  }
